...
futurama = Video.create(title: 'Futurama', description:futurama_description, category: Category.find_by_name('Animated'))
...
family_guy = Video.create(title: 'Family Guy', description:family_guy_description, category: Category.find_by_name('Animated'))
...
south_park = Video.create(title: 'South Park', description:south_park_description, category:Category.find_by_name('Animated'))
...
monk = Video.create(title: 'Monk', description:monk_description, category: Category.find_by_name('TV Dramas'))
...
suits = Video.create(title: 'Suits', description:suits_description, category:Category.find_by_name('TV Dramas'))
