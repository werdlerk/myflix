...
futurama = Video.create(title: 'Futurama', description:futurama_description, small_cover_url:'futurama.jpg', large_cover_url:'futurama_large.jpg', category: Category.find_by_name('Animated'))
...
family_guy = Video.create(title: 'Family Guy', description:family_guy_description, small_cover_url:'family_guy.jpg', large_cover_url:'family_guy_large.jpg', category: Category.find_by_name('Animated'))
...
south_park = Video.create(title: 'South Park', description:south_park_description, small_cover_url:'south_park.jpg', large_cover_url:'south_park_large.jpg', category:Category.find_by_name('Animated'))
...
monk = Video.create(title: 'Monk', description:monk_description, small_cover_url:'monk.jpg', large_cover_url:'monk_large.jpg', category: Category.find_by_name('TV Dramas'))
...
suits = Video.create(title: 'Suits', description:suits_description, small_cover_url:'suits_cover.jpg', large_cover_url:'suits_large.jpg', category:Category.find_by_name('TV Dramas'))

# User: koen
koen = User.create(name: "Koen Werdler", password: "password", email: "koen@werdler.com")
